...
public class ac_tcoin implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("ac_tcoin"), "com.it.fome.ac_tcoin");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, ac_tcoin.class);
...
public static com.it.fome.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"ac_home",Debug.moduleToString(com.it.fome.ac_home.class),"ac_hsef",Debug.moduleToString(com.it.fome.ac_hsef.class),"ac_lchats",Debug.moduleToString(com.it.fome.ac_lchats.class),"ac_shop",Debug.moduleToString(com.it.fome.ac_shop.class),"ac_tansfer",Debug.moduleToString(com.it.fome.ac_tansfer.class),"ac_telelogin",Debug.moduleToString(com.it.fome.ac_telelogin.class),"ac_tfreecoin",Debug.moduleToString(com.it.fome.ac_tfreecoin.class),"ac_tsearch",Debug.moduleToString(com.it.fome.ac_tsearch.class),"ac_tselect",Debug.moduleToString(com.it.fome.ac_tselect.class),"Act_Chat",Debug.moduleToString(com.it.fome.act_chat.class),"Activity",ac_tcoin.mostCurrent._activity,"cursor1",ac_tcoin._cursor1,"DateUtils",ac_tcoin.mostCurrent._dateutils,"FirebaseMessaging",Debug.moduleToString(com.it.fome.firebasemessaging.class),"glide",ac_tcoin.mostCurrent._glide,"lbl_icon",ac_tcoin.mostCurrent._lbl_icon,"lbl_nums",ac_tcoin.mostCurrent._lbl_nums,"LV",ac_tcoin.mostCurrent._lv,"Main",Debug.moduleToString(com.it.fome.main.class),"meno",ac_tcoin.mostCurrent._meno,"mimeno",ac_tcoin.mostCurrent._mimeno,"pnl_coins",ac_tcoin.mostCurrent._pnl_coins,"roundview",ac_tcoin.mostCurrent._roundview,"sql1",ac_tcoin._sql1,"Starter",Debug.moduleToString(com.it.fome.starter.class),"userid_t",ac_tcoin.mostCurrent._userid_t,"username_t",ac_tcoin.mostCurrent._username_t};
}
}