...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new anywheresoftware.b4a.ShellBA(this, null, null, "com.it.fome", "com.it.fome.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.it.fome.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
RDebugUtils.currentLine=393219;
 //BA.debugLineNum = 393219;BA.debugLine="CallSubDelayed(FirebaseMessaging, \"SubscribeToTop";
