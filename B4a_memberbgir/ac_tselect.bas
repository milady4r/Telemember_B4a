...
'	
	...
	Select Position
		...
		Case 3:
			lbl_name.Text="فروشگاه"
			lbl_notis.Text="خرید سکه"
			lbl_itemicon.Text=Chr(0xE854)
		Case 4:
			lbl_name.Text="انتقال سکه"
			lbl_notis.Text="انتقال سکه به دیگر کاربران"
			lbl_itemicon.Text=Chr(0xE863)
...
'			Sleep(0)
		...
		Case 1:
			StartActivity(ac_tcoin)
			SetAnimation("anim2", "anim1")
			
		Case 2:
			ac_hsef.typesef=1
			StartActivity(ac_hsef)
			SetAnimation("anim2", "anim1")
			
		Case 3:
			ac_shop.typesef=1
			StartActivity(ac_shop)
			SetAnimation("anim2", "anim1")
			
		Case 4:
			ac_tansfer.type_s=1
			StartActivity(ac_tansfer)
			SetAnimation("anim2", "anim1")
